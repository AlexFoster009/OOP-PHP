    ...
    <body>
        <div class="container">
            ...
            <div>
                ...
                <p class="text-center">
                    <br>
                    <?php echo $ship1Quantity; ?> <?php echo $ship1->getShipName(); ?><?php echo $ship1Quantity > 1 ? 's': ''; ?>
                    VS.
                    <?php echo $ship2Quantity; ?> <?php echo $ship2->getShipName(); ?><?php echo $ship2Quantity > 1 ? 's': ''; ?>
                </p>
            </div>
            <div class="result-box center-block">
                <h3 class="text-center audiowide">
                    Winner:
                    <?php if (['winning_ship']): ?>
                        <?php echo $battleResult->isThereAWinner(); ?>
                    <?php else: ?>
                        Nobody
                    <?php endif; ?>
                </h3>
                <p class="text-center">
                    ...
                    <?php else: ?>
                        The <?php echo $battleResult->getWinningShip()->getShipName(); ?>
                        <?php if ($battleResult->wereJediPowersUsed()): ?>
                            used its Jedi Powers for a stunning victory!
                        <?php else: ?>
                            overpowered and destroyed the <?php echo $battleResult->getLosingShip()->getShipName(); ?>s
                        <?php endif; ?>
                    <?php endif; ?>
                </p>
                <h3>Ship Health</h3>
                <dl class="dl-horizontal">
                    <dt><?php echo $ship1->getShipName(); ?></dt>
                    <dt><?php echo  $ship1->getStrength(); ?></dt>
                    <dt><?php echo  $ship2->getShipName(); ?></dt>
